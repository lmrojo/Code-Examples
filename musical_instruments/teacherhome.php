    ...
    <div id="main_content">
    	...
    	<div class="center_content">
            ...
            <div class="products">
              ...
              Here teachers information, no adresses
            </div>
            ...
            <div class="new_products">
                    ...
                    <div class="prod_box">
                      <div class="prod_details">
                   	    <h1>Menu</h1>
                        <p>
                        <form method="post"><input type="submit" value="Students phone numbers" name="register"></form><br>
                    ...
                    <div class="prod_box">
                    	<img src="images/p2.gif" alt="" width="42" height="126" class="prod_img" title=""/>
                        <div class="prod_details">
                       	  <h1>Display</h1>
                            <p>
      kjhjjkbkj
